...
- Update the logic in middleware to set the **isFreeAppUser** attribute in req. Use this attribute in the route handler for setting the isFreeAppUser attributes of User and Order collection. - Write a POST api for order purchase that takes a userId and a productId in request body. 
